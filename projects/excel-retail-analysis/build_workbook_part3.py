...
ws["B3"].font = Font(name=FONT_NAME, size=11, italic=True, color="595959")
...
for label, formula, fmt, col in kpis:
    ...
    cell_val.font = Font(name=FONT_NAME, size=22, bold=True, color=NAVY)
...
ws["B10"].font = Font(name=FONT_NAME, size=10.5, italic=True, color=ACCENT)
ws.row_dimensions[10].height = 28
ws["B10"].alignment = Alignment(wrap_text=True, vertical="center")

# ---- Charts (Excel default styling) ----
